...
const translations = {
    ko: {
        ...
        'f.product': '상품명',
        'f.product.ph': '상품명을 입력하세요',
        'f.purchase': '매입가',
        'f.currency': '판매 타겟 통화 선택',
    ...
    en: {
        ...
        'h.sub': 'Calculate overseas sales margins - accurately calculate fees and establish optimal pricing strategies',
        'f.product': 'Product Name',
        'f.product.ph': 'Enter product name',
        'f.purchase': 'Purchase Price',
        'f.currency': 'Select Target Currency',
        ...
        'b.calc': 'Calculate Margin',
        'r.title': 'Calculation Result',
        'r.profit': 'Net Profit (Margin)',
        'p.title': 'Platform Fee Information',
    ...
    ja: {
        ...
        'f.product': '商品名',
        'f.product.ph': '商品名を入力してください',
        'f.purchase': '仕入れ価格',
        'f.currency': '販売ターゲット通貨を選択',
    ...
    vi: {
        ...
        'f.product': 'Tên sản phẩm',
        'f.product.ph': 'Nhập tên sản phẩm',
        'f.purchase': 'Giá nhập',
        'f.currency': 'Chọn đơn vị tiền tệ mục tiêu',
        'f.selling': 'Giá bán quốc tế (*Tỷ giá tự động áp dụng)',
        'f.domestic': 'Phí vận chuyển nội địa (Kho → Điểm gom hàng nội địa)',
        'f.intl': 'Phí vận chuyển quốc tế (Điểm gom hàng → Khách hàng quốc tế)',
        'b.calc': 'Tính lợi nhuận',
        'r.title': 'Kết quả tính toán',
        'r.profit': 'Lợi nhuận ròng (Biên lợi nhuận)',
        'p.title': 'Thông tin phí theo nền tảng',
